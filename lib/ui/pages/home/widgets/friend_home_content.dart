...
class _FriendHomeContentState extends ConsumerState<FriendHomeContent> with WidgetsBindingObserver {
  ...
  Future<void> _loadData() async {
    try {
      ...
      final pets = await ref.read(petUseCaseProvider).getMyPets(widget.friendUserId);
      final feedRepository = ref.read(feedRepositoryProvider);
      final recentFeeds = await feedRepository.getMyRecentFeeds(widget.friendUserId);
